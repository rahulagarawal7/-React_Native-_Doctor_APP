...
const On_BordingScreen01=({ navigation })=>{
  ...
  return(
   ...
   <View >
      <Image
        ...
        source={require('../assets/background/Ellipse153.png')}
      />
      </View>
      <View>
      <Image
        style={styles.DrImg}
        source={require('../assets/images/Ellipse154.png')}
      />
      </View>
...
onPress={()=>navigation.navigate('On_BordingScreen02')
}
>
  <Text
 
  style={styles.btnTextStyle}>Get Started</Text>
</TouchableOpacity>
<Text
...
export default On_BordingScreen01